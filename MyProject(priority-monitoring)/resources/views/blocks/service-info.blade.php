<div class="service-info">
    ...
    <div class="service-info__cards">
        ...
        <div class="service-info__3">
            ...
            <x-service-info.card src="{{ asset('img/service-info/3_row/2.svg') }}" text="Система оповещения и эвакуации людей" class="service-info__element"/>
            <x-service-info.card src="{{ asset('img/service-info/3_row/3.svg') }}" text="Мероприятия для пожарной безопасности" class="service-info__element"/>
            <x-service-info.card src="{{ asset('img/service-info/3_row/4.svg') }}" text="Планы пожарной эвакуации" class="service-info__element"/>
        </div>
    </div>
