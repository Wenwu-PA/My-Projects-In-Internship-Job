...
<body>
    ...
    <div class="cover">
        <div class="cover__container">
            <h1 class="container__h1">Разработка веб-сервисов<br> и сайтов с 2013 года</h1>
            <a  class="container_phone_icon" href="tel:+7 931 009-37-72">
                <i class="fa-solid fa-mobile-screen-button"></i>
...
<footer class="footer">
        <div class="footer__contacts" id="contacts">
            <div class="contacts__group1">
                <p class="contacts__group1__p">ОТДЕЛ ПРОДАЖ</p>
                <div class="contacts_group1__contacts">
                <div class="contacts__group1__phone-number"><a href="" class="num_ph">+7 931 009-37-72</a></div>
                    <div class="contacts__group1__social-media">
                        <a class="contacts__group__social-media__telegram" href="">
                            <i class="fa-solid fa-paper-plane"></i>                            
                                    <p>
                                        Telegram
                                    </p> 
                                </a>
                        <a class="contacts__group__social-media__whatsapp" href="">
            ...
            <div class="contacts__group2">
                <p class="contacts__group2__p">СЕРВИСНЫЙ ЦЕНТР</p>
                <div class="contacts_group1__contacts">
                <div class="contacts__group2__phone-number"><a href="" class="num_ph">+7 931 009-37-74</a></div>
                    <div class="contacts__group2__social-media">
                        <a class="contacts__group__social-media__telegram" href="">
                            <i class="fa-solid fa-paper-plane"></i>                             
                                    <p>
                                        Telegram
            ...
            <div class="contacts__mail-and-time">
                <a href="" class="footer__contacts__mail-and-time__mail">mail@studio2i.ru</a>
                <p class="footer__contacts__mail-and-time__time">По будням с 10:00 до 19:00 (по Москве)</p>
            </div>
            </div>
        <div class="footer__copyrights" id="footer__copyrights">
            <p class="footer__copyrights__p">© 2013–2025 Диджитал-агентство 2И</p>
            <p class="footer__copyrights__p2">ИП Артамонов Иван Сергеевич<br> ОГРНИП 316470400116880</p>
        </div>
